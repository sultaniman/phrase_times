defmodule PhraseTimezonesWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PhraseTimezonesWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PhraseTimezonesWeb.Gettext, "errors", msg, opts)
    end
  end
