defmodule PhraseTimesWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PhraseTimesWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PhraseTimesWeb.Gettext, "errors", msg, opts)
    end
  end
